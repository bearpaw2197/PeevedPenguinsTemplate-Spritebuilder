 ...
 *  @see CCColor
 */
-(instancetype)initWithGroups:(NSArray *)groups specularColor:(CCColor *)specularColor shininess:(float)shininess NS_DESIGNATED_INITIALIZER NS_DESIGNATED_INITIALIZER;
